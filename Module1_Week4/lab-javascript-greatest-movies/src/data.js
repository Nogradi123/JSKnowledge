...
//   const getDirector = moviesArray.filter((director, genre) => {
...
//   return getDirector && getDramaMovies
// }
...
//   const totalScores = moviesArray.reduce((sum, currentMovie) => {
//     if(currentMovie.hasOwnProperty('score') || !currentMovie.hasOwnProperty('score')) {
//       sum.totalScores += currentMovie.score;
//     }
//     return sum 
//   }, {totalScores: 0});
  
//   return Number(Math.round(totalScores * 100) / 100);
